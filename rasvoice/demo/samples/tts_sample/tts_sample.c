...
int tts_begin(const char* pytext , const char* pyfilename)
{
	int         ret                  = MSP_SUCCESS;
	...
	*/
	const char* session_begin_params = "voice_name = jinger, text_encoding = UTF8, sample_rate =16000, speed = 0, volume = 100, pitch = 50, rdn = 2";
	const char* filename             =  pyfilename; //合成的语音文件名称
